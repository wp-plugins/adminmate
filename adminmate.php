...
/*
  ...
  Description: Everything you need to customize your administration screens, login screen, post table columns, main navigation, toolbar, styling/colorizing and more.
  Version: 1.0.3a
  Author: JD Tool Kit
...
class JDTK_Admin_Mate {
  ...
  public function jdtk_enqueue_scripts() {
    ...
    if (class_exists('JDTK_Options_Login')) {
      $capsule['login'] = JDTK_Options_Login::initialization();
    }
...
//    }
  ...
  public function get_actions() {
    ...
    if (is_admin()) {
      ...
      self::$TABS_CONTENTS['login']->add_actions();
    }
  }
