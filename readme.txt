...
* Edit background/foreground color of admin menu/submenu, including when they're active/hovered
* Update font weight of menu items
...
* Hide the admin bar only for the front side of your website.
* Hide the admin bar's menu/submenu items.
