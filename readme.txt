...
1. Examples of Administrator and Login Screens, before & after using AdminMate.
2. Styling tab
3. Navigation Menu tab
4. Toolbar tab
5. The Footer tab
6. Columns tab, configuration, and the result
7. Login Screen tab, customization, and the result
