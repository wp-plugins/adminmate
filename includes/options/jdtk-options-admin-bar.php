 ...
 * @author JD Tool Kit
 */
class JDTK_Options_Admin_Bar extends JDTK_Type_UI {
  ...
  public function main_title() {
    echo "<li class='tab main-tab " . self::ID . "'><a href='#" . self::ID . "'>Admin Bar</a></li>";
  }
  ...
  public function main_content() {
    ...
    $items_1 = array(
      $this->inv(self::INV_3, array(
        'type' => "checkbox_label",
        'title' => __('Do not hide menu bar items for Administrator.', 'jdtk'),
        "class" => "more-left-1",
        "class_left" => "left align-right"
        ), 'bar', 'general', 'not_hide'
      ), $this->inv(self::INV_3, array(
        "type" => "button_confirm",
        "title" => __("Reset Admin Menu Bar Settings", 'jdtk'),
        "class" => "more-left-1",
        "dialog" => array(
          "title" => __("Warning! Resetting your Admin Menu Bar options", 'jdtk'),
          "message" => __("Your custom admin menu bar options will be deleted.<br>"
            . "Your WordPress admin menu bar will be restored to its defaults.", 'jdtk'),
    ...
    $items_2 = array($this->inv(self::INV_3, array(
        ...
        "type" => "checkbox_label",
        "title" => __("Admin bar only on the site pages", 'jdtk')
        ), 'bar', 'hide', 'bar_site'
      )
    );
