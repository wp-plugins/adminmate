 ...
 * @author JD Tool Kit
 */
class JDTK_Options_Admin_Footer extends JDTK_Type_UI {
  ...
  public function main_title() {
    echo "<li class='tab main-tab " . self::ID . "'><a href='#" . self::ID . "'>Admin Footer</a></li>";
  }
  ...
  public function main_content() {
    ...
    array_push($items, $this->inv(self::INV_3, array(
        "type" => "button_confirm",
        "title" => __("Reset Admin Footer Settings", 'jdtk'),
        "class" => "more-left-1",
        "dialog" => array(
          "title" => __("Warning! Resetting your Admin Footer options", 'jdtk'),
          "message" => __("Your custom admin footer options will be deleted.<br>"
            . "Your WordPress admin footer will be restored to its defaults.", 'jdtk'),
