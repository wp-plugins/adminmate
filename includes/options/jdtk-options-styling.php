    ...
    self::$tabs = array(
      'background' => array(
        ...
        "meta_data" => array(
          ...
          'reset' => array(
            "type" => "button_confirm",
            "title" => __("Reset Background Style Settings", 'jdtk'),
            "dialog" => array(
        ...
        "meta_data" => array(
          ...
          'reset' => array(
            "type" => "button_confirm",
            "title" => __("Reset Navigation Menu Style Settings", 'jdtk'),
            "dialog" => array(
              "title" => __("Warning! You are about to reset the navigation menu styling options", 'jdtk'),
              "message" => __("Your setup parameters for this navigation menu styling will be deleted.<br>"
                . "Your WordPress will be restored to the default.", 'jdtk'),
              "yes-text" => __("Reset", 'jdtk'),
              "no-text" => __("Cancel", 'jdtk'),
              "width" => 460))
        ...
        "meta_data" => array(
          ...
          'reset' => array(
            "type" => "button_confirm",
            "title" => __("Reset Toolbar Style Settings", 'jdtk'),
            "dialog" => array(
              "title" => __("Warning! You are about to reset the toolbar styling options", 'jdtk'),
              "message" => __("Your setup parameters for this toolbar styling will be deleted.<br>"
                . "Your WordPress will be restored to the default.", 'jdtk'),
              "yes-text" => __("Reset", 'jdtk'),
              "no-text" => __("Cancel", 'jdtk'),
              "width" => 460))
        ...
        "meta_data" => array(
          ...
          'reset' => array(
            "type" => "button_confirm",
            "title" => __("Reset Post Tables Style Settings", 'jdtk'),
            "dialog" => array(
        ...
        "meta_data" => array(
          ...
          'reset' => array(
            "type" => "button_confirm",
            "title" => __("Reset Button Style Settings", 'jdtk'),
            "dialog" => array(
        ...
        "meta_data" => array(
          ...
          'reset' => array(
            "type" => "button_confirm",
            "title" => __("Reset Global Style Settings", 'jdtk'),
            "dialog" => array(
        ...
        "meta_data" => array(
          'h-favicon' => array(
            'type' => "separator",
            'title' => __("Favicon (for Administration Screens)", 'jdtk'),
            'class' => "separator"),
          'wpfavicon' => array(
            "type" => "label_text_button",
          ...
          'h-top' => array(
            'type' => "separator",
            'title' => __("On the Top (under Toolbar)", 'jdtk'),
            'class' => "separator"),
          ...
          'reset' => array(
            "type" => "button_confirm",
            "title" => __("Reset Other Style Settings", 'jdtk'),
            "dialog" => array(
