 ...
 * @author JD Tool Kit
 */
class JDTK_Options_Login extends JDTK_Type_UI {
  ...
  public static function initialization() {
    if (!isset(self::$login_reference)) {
      self::$login_reference = array(
        'h-favicon' => array(
          'type' => "separator",
          'title' => __("Favicon (for Login Screen)", 'jdtk'),
          'class' => "separator-1"),
        'favicon' => array(
  ...
  public function main_title() {
    echo "<li class='tab main-tab " . self::ID . "'><a href='#" . self::ID . "'>Login Screen</a></li>";
  }
  ...
  public function main_content() {
    ...
    array_push($items, $this->inv(self::INV_3, array(
        "type" => "button_confirm",
        "title" => __("Reset Login Screen Settings", 'jdtk'),
        "class" => "more-left-1",
        "dialog" => array(
          "title" => __("Warning! Resetting your Login Screen options", 'jdtk'),
          "message" => __("Your custom login screen options will be deleted.<br>"
            . "Your WordPress login screen will be restored to its defaults.", 'jdtk'),
